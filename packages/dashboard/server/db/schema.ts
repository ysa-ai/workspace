...
export const projects = pgTable("projects", {
  ...
  container_stack_size: integer("container_stack_size"),
  ...
  container_init_commands: text("container_init_commands"),
  packages: text("packages"),
  bypass_hosts: text("bypass_hosts"),
  ...
  app_credentials: text("app_credentials"),
  is_default: boolean("is_default").notNull().default(false),
